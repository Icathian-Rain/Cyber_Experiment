define('amd_modules/@baidu/video-meeting/dist/index', [
    ...
    return function (t) {
        ...
        function (t, e, n) {
            ...
            var a = n(4), i = n(0), o = a.__importDefault(n(6)), r = n(5), s = a.__importDefault(n(113)), c = [
                    ...
                    return a.__extends(e, t), e.prototype.initData = function () {
                        ...
                        var n = new Date().getTime(), a = this.parseDate(n), i = this.parseDate(new Date(n - 86400000).getTime()), o = this.parseDate(new Date(n + 86400000).getTime());
                        ...
                        var t = this, e = this, n = this.data.get('meetStatus'), i = this.data.get('myMeet'), o = this.data.get('page'), r = this.ref('areaContent'), s = this.data.get('meetList'), c = this.data.get('originList');
                        ...
                        var e = this, n = this.data.get('page');
                        ...
                        var t = this.data.get('meetList'), e = this.ref('areaContent');
                        ...
                        var e = this, n = this.ref('areaContent'), a = this.data.get('originList');
        ...
        function (t, e, n) {
            ...
            var a = n(4), i = n(0), o = n(5), r = function (t) {
                    ...
                    return a.__extends(e, t), e.prototype.initData = function () {
                        ...
                        var t = this, e = this.data.get('item'), n = this.data.get('bsToken'), a = new FormData(), i = this;
                        ...
                        var e = new Date(), n = e.getTime(), i = this.selectListInit('reOrderMeet', e, 'start'), o = this.selectListInit('reOrderMeet', new Date(n + 1740000), 'end'), r = t.startTime, s = t.endTime;
                        ...
                        var c = this.processCal('start', r, i), l = this.processCal('end', s), p = this.getSimpleMeetData(t), d = {
                                startSelectList: i,
                                endSelectList: o,
                        ...
                        var e = this.selectListInit('modifyMeet', new Date(1000 * t.startTime.utcTime), 'start'), n = this.selectListInit('modifyMeet', new Date(1000 * t.startTime.utcTime + 1740000), 'end'), i = t.startTime, o = t.endTime, r = this.processCal('start', i, e), s = this.processCal('end', o), c = this.getSimpleMeetData(t), l = {
                        ...
                        var a = 1000 * e.utcTime, i = new Date(a), o = {
                        ...
                        this.checkPopClose();
                        var e = this.ref('meetItemQuick'), n = '';
                        ...
                        if (0 === this.data.get('meetStatus')) {
                            this.checkPopClose();
                            var n = this;
                            fetch('/home/meeting/data/detail?&r=' + t.roomTag, { method: 'get' }).then(function (t) {
                                return t.json();
                            }).then(function (e) {
                                if (0 === e.errno) {
                                    var a = e.data, i = {
                        ...
                        var t = this, e = this.data.get('showBoard');
                        this.nextTick(function () {
                    ...
                    }, e.components = { 'c-popup': o.Popup }, e.computed = {
                        memberName: function () {
        ...
        function (t, e, n) {
            'use strict';
            e.__esModule = !0;
            var a = n(4), i = n(0), o = n(5), r = n(31), s = n(9), c = function (t) {
                    function e() {
                        return null !== t && t.apply(this, arguments) || this;
                    }
                    return a.__extends(e, t), e.prototype.initData = function () {
                        ...
                        text: function () {
                            var t = this.data.get('flowType'), e = this.data.get('browserPC');
                            if ('unlogin' === t)
                                return {
                                    title: '参与会议需要登录',
                            ...
                            var n = this.data.get('browserInfo'), a = '', i = '//www.baidu.com/s?wd=' + encodeURIComponent('chrome网络浏览器下载') + '&rsv_dl=meeting';
        ...
        function (t, e, n) {
            var a = n(1), i = [n(37)], o = n(39), r = n(10)['default'];
        ...
        function (t, e, n) {
            (e = n(3)(!1)).push([
                ...
                ''
            ]), e.locals = { hide: 'hide_3y2AL' }, t.exports = e;
        },
        function (t, e) {
        ...
        function (t, e, n) {
            var a = n(1), i = [n(41)], o = n(43), r = n(11)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(48)], o = n(50), r = n(13)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(52)], o = n(54), r = n(14)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(56)], o = n(58), r = n(15)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(63)], o = n(65), r = n(18)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(67)], o = n(69), r = n(19)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(71)], o = n(73), r = n(20)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(75)], o = n(77), r = n(21)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(79)], o = n(81), r = n(22)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(84)], o = n(86), r = n(23)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(91)], o = n(93), r = n(25)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(98)], o = n(100), r = n(28)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(102)], o = n(104), r = n(29)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(106)], o = n(108), r = n(30)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(110)], o = n(112), r = n(32)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(114)], o = n(116), r = n(33)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(118)], o = n(120), r = n(34)['default'];
        ...
        function (t, e, n) {
            var a = n(1), i = [n(122)], o = n(124), r = n(35)['default'];
